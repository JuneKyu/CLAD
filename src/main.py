...
def main():
    ...
    # data_type : 'swat', 'wadi', 'cola', 'reuters', 'newsgroups', 'imdb'
    ...
    #          # give labels to each of the clusters
    ...
    #
    #          # fix when cluster is set to '0' to all data
    ...
    #                  # check which clusters should be used (brute force)
    #                  beta = 1
