...
#   --temperature 1000 --perturbation 0.001 --plot_clustering False --classifier_epochs 200 \
#   --classifier_lr 0.0001 --plot_clustering True --save_cluster_model True
...
python ../main.py --data_path '../../data' --dataset_name 'tiny_imagenet' --cluster_type 'cvae_base' \
  --dec_pretrain_epochs 300 --dec_train_epochs 300 --classifier 'cnn' --cluster_num 10 --n_hidden_features 200 \
  --normal_class_index_list 0\
  --temperature 1000 --perturbation 0.001 --plot_clustering False --classifier_epochs 200 \
  --classifier_lr 0.0001 --plot_clustering True --save_cluster_model True
