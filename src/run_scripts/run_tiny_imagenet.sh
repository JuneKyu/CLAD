...
# 1
# python ../main.py --data_path '../../data' --dataset_name 'tiny_imagenet' --cluster_type 'cvae_large' \
#   --dec_pretrain_epochs 100 --dec_train_epochs 100 --classifier 'resnet' --cluster_num 10 --n_hidden_features 200 \
#   --normal_class_index_list 1\
#   --temperature 1000 --perturbation 0.00001 --classifier_epochs 100 \
#   --classifier_lr 0.0000001 --plot_clustering True --load_cluster_model True
# 2
# python ../main.py --data_path '../../data' --dataset_name 'tiny_imagenet' --cluster_type 'cvae_large' \
#   --dec_pretrain_epochs 300 --dec_train_epochs 300 --classifier 'resnet' --cluster_num 30 --n_hidden_features 200 \
...
# 4
# python ../main.py --data_path '../../data' --dataset_name 'tiny_imagenet' --cluster_type 'cvae_large' \
#   --dec_pretrain_epochs 100 --dec_train_epochs 100 --classifier 'resnet' --cluster_num 15 --n_hidden_features 200 \
