...
from models.ptsdae.dae import DenoisingAutoencoder
...
def pretrain(
    ...
    for index in range(number_of_subautoencoders):
        pdb.set_trace()
        # TODO make new convolutional variational autoencoder without using subfunctions
