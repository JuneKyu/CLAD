...
class SWaT_Dataset(object):
    ...
    def __init__(self, root_dir:str):
        ...
        self.train_x, self.train_y, self.val_x, self.val_y, self.test_x, self.test_y = swat_dataset(root_dir)
...
def swat_dataset(directory = '../data'):
    ...
    train_concat_x = np.concatenate((train_x_modify_swat, train_x_modify_swat_freq), 1)
    test_concat_x = np.concatenate((test_x_modify_swat, test_x_modify_swat_freq), 1)
